...
// =============================================================================
// ConnectionService — manages WebRTC/WHIP connection to SAMBA Engine
//
...
class ConnectionService extends ChangeNotifier {
  ...
  Future<void> _createPeerConnection(MediaStream stream) async {
    ...
    // WHIP POST — send offer to SAMBA Engine
    ...
    debugPrint('[CameraSAMBA] WHIP handshake complete → waiting for ICE...');
  }
  ...
  Future<void> disconnect() async {
    ...
    debugPrint('[CameraSAMBA] Disconnected from engine.');
  }
